		...
		if (argIndex === 0 || (args[0] !== "let" && args[0] !== "mod" && args[0] !== "play")) {
			if (!space) {
				switch (argIndex) {
					case 0:
						return this.genResp(
							[this.genSuggestion('frame', 'Creating new Frame', 'keyword')
							, this.genSuggestion('scene', 'Creating new Scene', 'keyword')
							, this.genSuggestion('macro', 'Write a macro', 'keyword')
							, this.genSuggestion('declare', 'Declare a game object', 'keyword')
							, this.genSuggestion('let', 'Initialize a variable', 'keyword')
							, this.genSuggestion('mod', 'Modify a variable', 'keyword')
							, this.genSuggestion('create','Create a object','keyword')
							, this.genSuggestion('start','Marks the start of the program')
							, this.genSuggestion('play','Plays a specific scene')
						]);
					case 1:
						return this.genResp([]);
					case 2:
